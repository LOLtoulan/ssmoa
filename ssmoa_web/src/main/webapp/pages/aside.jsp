    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
               <span> <security:authentication property="principal.username"></security:authentication></span>
            ...
            <li class="treeview"><a href="#"> <i class="fa fa-cogs"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li id="system-setting">
                        ...
                        <a href="${pageContext.request.contextPath}/user/findAll.do?page=1&size=4"> <i class="fa fa-circle-o"></i> 用户管理</a>
